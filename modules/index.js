import 'https://unpkg.com/tesseract.js@2.0.0-beta.1/dist/tesseract.min.js';
import colors from './variables.js';
import convertResultsToTemplateCommands from './convertToWiki.js';
...
const parseScriptImage = async (data) => {
  ...
  for (let i = 0, c = scriptImg.height / entryHeight; i < c; i++) {
    ...
    if (entryType !== 'loopEnd' && entryType !== 'shout' && entryType !== 'wait') {
      ...
      if (entryType === 'loopStart' && details[1]) {
